...
public class QmlSpellcheckingStrategy extends SpellcheckingStrategy {

    @Override
    public @NotNull Tokenizer<?> getTokenizer(PsiElement element) {
        if (element instanceof PsiComment) {
            return new QmlCommentTokenizer();
        }

        if (element instanceof QmlProperty) {
            return new QmlPropertyTokenizer();
        }

        return EMPTY_TOKENIZER;
    }

    private static class QmlCommentTokenizer extends Tokenizer<PsiComment> {
    ...
    private static class QmlPropertyTokenizer extends Tokenizer<QmlProperty> {
