...
public class QmlChooseByNameContributor implements ChooseByNameContributorEx {
    @Override
    public void processNames(@NotNull Processor<? super String> processor,
        ...
        List<String> propertyKeys = ContainerUtil.map(
                QmlUtil.findProperties(project), QmlProperty::getKey);
    ...
    public void processElementsWithName(@NotNull String name,
        ...
        List<NavigationItem> properties = ContainerUtil.map(
                QmlUtil.findProperties(parameters.getProject(), name),
