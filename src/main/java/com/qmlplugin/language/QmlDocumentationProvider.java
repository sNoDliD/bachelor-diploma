 ...
 */
public class QmlDocumentationProvider extends AbstractDocumentationProvider {
    /**
     * For the Qml Language, we don't have online documentation. However, if your language provides
    ...
    /**
     * Extracts the key, value, file and documentation comment of a Qml key/value entry and returns
     * a formatted representation of the information.
     */
    @Override
    public @Nullable String generateDoc(PsiElement element, @Nullable PsiElement originalElement) {
        if (element instanceof QmlProperty) {
            final String key = ((QmlProperty) element).getKey();
            final String value = ((QmlProperty) element).getValue();
            final String file = SymbolPresentationUtil.getFilePathPresentation(element.getContainingFile());
            final String docComment = QmlUtil.findDocumentationComment((QmlProperty) element);
    ...
    /**
     * Provides the information in which file the Qml language key/value is defined.
     */
    @Override
    ...
    /**
     * Provides documentation when a Qml Language element is hovered with the mouse.
     */
    @Override
