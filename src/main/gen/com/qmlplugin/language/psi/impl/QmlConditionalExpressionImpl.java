...
public class QmlConditionalExpressionImpl extends ASTWrapperPsiElement implements QmlConditionalExpression {

  public QmlConditionalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
...
//    visitor.visitConditionalExpression(this);
  ...
  @Override
  @NotNull
  public List<QmlUnaryExpression> getUnaryExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, QmlUnaryExpression.class);
  }
