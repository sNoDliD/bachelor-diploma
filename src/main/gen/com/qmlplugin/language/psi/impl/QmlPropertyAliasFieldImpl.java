...
public class QmlPropertyAliasFieldImpl extends ASTWrapperPsiElement implements QmlPropertyAliasField {

  public QmlPropertyAliasFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QmlVisitor visitor) {
    visitor.visitPropertyAliasField(this);
  }
