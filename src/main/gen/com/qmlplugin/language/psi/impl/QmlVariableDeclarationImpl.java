...
public class QmlVariableDeclarationImpl extends ASTWrapperPsiElement implements QmlVariableDeclaration {

  public QmlVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
