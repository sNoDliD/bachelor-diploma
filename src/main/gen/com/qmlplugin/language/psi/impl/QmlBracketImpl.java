...
public class QmlBracketImpl extends ASTWrapperPsiElement implements QmlBracket {

  public QmlBracketImpl(@NotNull ASTNode node) {
    super(node);
  }
...
//    visitor.visitBracket(this);
  ...
  @Override
  @Nullable
  public QmlBracket getBracket() {
    return findChildByClass(QmlBracket.class);
  }
