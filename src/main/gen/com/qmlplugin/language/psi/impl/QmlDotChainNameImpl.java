...
public class QmlDotChainNameImpl extends ASTWrapperPsiElement implements QmlDotChainName {

  public QmlDotChainNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QmlVisitor visitor) {
    visitor.visitDotChainName(this);
  }
