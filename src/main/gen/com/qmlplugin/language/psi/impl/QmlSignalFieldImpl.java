...
public class QmlSignalFieldImpl extends ASTWrapperPsiElement implements QmlSignalField {

  public QmlSignalFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QmlVisitor visitor) {
    visitor.visitSignalField(this);
  }
