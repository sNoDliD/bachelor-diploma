...
public class QmlJsAssignmentImpl extends ASTWrapperPsiElement implements QmlJsAssignment {

  public QmlJsAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QmlVisitor visitor) {
//    visitor.visitJsAssignment(this);
  }
