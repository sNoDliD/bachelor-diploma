...
public class QmlExpressionImpl extends ASTWrapperPsiElement implements QmlExpression {

  public QmlExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<QmlDotChainName> getDotChainNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, QmlDotChainName.class);
  }
